...
<footer class="footer-distributed" style="background-color:black" id="aboutUs">
	...
	<div class="footer-left">
		<h3 style="font-family: 'Times New Roman', cursive;">E-Kishan portal &copy; </h3>
		<!--	<div class="logo">
				<a href="index.php"><img src="" width="200px"></a>
			</div>-->
		<br />
	...
	<div class="footer-center">
		<div>
			...
			<p style="font-size:20px">E-Kishan Fam<span>Vormir</span></p>
		</div>
		<div>
			<i class="fa fa-phone"></i>
			<p style="font-size:20px">9110069572</p>
		</div>
		<div>
			<i class="fa fa-envelope"></i>
			<p style="font-size:20px"><a href="mailto:E-Kishan portal@gmail.com"
					style="color:white">nishant02121997@gmail.com</a></p>
		</div>
	</div>

	<div class="footer-right">
		<p class="footer-company-about" style="color:white">
			<span style="font-size:20px"><b>About E-Kishan portal</b></span>
			E-Kishan portal is e-commerce trading platform for grains & grocerries...
		</p>
